  ...
  const contactMethods = [
    {
      icon: Mail,
      label: 'Email',
      value: 'edgarmed159@gmail.com',
      action: 'mailto:edgarmed159@gmail.com',
      color: '#00ff9d',
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'github.com/edgarmedrano',
      action: 'https://github.com/edgarmedrano',
      color: '#f0f6fc',
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'linkedin.com/in/edgarmedrano',
      action: '#',
      color: '#0a66c2',
    },
    {
